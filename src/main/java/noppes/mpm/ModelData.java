  ...
  implements IExtendedEntityProperties
{
  ...
  public EntityLivingBase getEntity(World world, EntityPlayer player) {
    ...
    if (this.entity == null) {
      try {
        this.entity = ((EntityLivingBase)this.entityClass.getConstructor(new Class[] { World.class }).newInstance(new Object[] { world }));
  ...
  public ModelData copy() { ModelData data = new ModelData();
  ...
  private boolean isSleeping(EnumAnimation animation) { return (animation == EnumAnimation.SLEEPING_EAST) || (animation == EnumAnimation.SLEEPING_NORTH) || (animation == EnumAnimation.SLEEPING_SOUTH) || (animation == EnumAnimation.SLEEPING_WEST); }
