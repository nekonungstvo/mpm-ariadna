...
public class GuiCreationScreen extends GuiModelInterface implements ITextfieldListener
{
  ...
  public GuiCreationScreen() {
    ...
    for (Object name : mapping.keySet()) {
      ...
      try {
        if (EntityLiving.class.isAssignableFrom(c)) if ((c.getConstructor(new Class[] { World.class }) != null) && (!Modifier.isAbstract(c.getModifiers())) && 
  ...
  private void showPlayerButtons() {
    ...
    y += 22;addButton(new GuiNpcButton(8, this.guiLeft + 4, y, 96, 20, "Scale"));
    
    y += 22;addButton(new GuiNpcButton(4, this.guiLeft + 50, y, 50, 20, "selectServer.edit"));
    addLabel(new GuiNpcLabel(1, "Head", this.guiLeft, y + 5, 16777215));
    
    y += 22;addButton(new GuiNpcButton(5, this.guiLeft + 50, y, 50, 20, "selectServer.edit"));
    addLabel(new GuiNpcLabel(2, "Body", this.guiLeft, y + 5, 16777215));
    
    y += 22;addButton(new GuiNpcButton(6, this.guiLeft + 50, y, 50, 20, "selectServer.edit"));
    addLabel(new GuiNpcLabel(3, "Arms", this.guiLeft, y + 5, 16777215));
    
    y += 22;addButton(new GuiNpcButton(7, this.guiLeft + 50, y, 50, 20, "selectServer.edit"));
    addLabel(new GuiNpcLabel(4, "Legs", this.guiLeft, y + 5, 16777215));
    
    y += 22;addButton(new GuiNpcButton(9, this.guiLeft + 50, y, 50, 20, new String[] { "Default", "Female", "Male", "Goblin Male" }, this.playerdata.soundType));
    addLabel(new GuiNpcLabel(5, "Sounds", this.guiLeft, y + 5, 16777215));
  }
  ...
  private boolean isIgnored(String tag) { for (String s : this.ignoredTags)
      if (s.equals(tag))
        return true;
    return false;
  }
