...
public class GuiNpcTextField extends GuiTextField
{
  ...
  public int id;
  public int min = 0; public int max = Integer.MAX_VALUE; public int def = 0;
  ...
  public boolean isEmpty() { return getText().trim().length() == 0; }
  


  public int getInteger() { return Integer.parseInt(getText()); }
  ...
  public void setMinMaxDefault(int i, int j, int k) { this.min = i;
    this.max = j;
    this.def = k;
  }
  
  public static void unfocus() { if (activeTextfield != null)
