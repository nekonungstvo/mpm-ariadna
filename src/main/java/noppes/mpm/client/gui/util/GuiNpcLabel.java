...
public class GuiNpcLabel
{
  ...
  public void drawLabel(net.minecraft.client.gui.GuiScreen gui, FontRenderer fontRenderer) { if (this.enabled)
      fontRenderer.drawString(this.label, this.x, this.y, this.color);
  }
  
  public void center(int width) { int size = net.minecraft.client.Minecraft.getMinecraft().fontRenderer.getStringWidth(this.label);
    this.x += (width - size) / 2;
  }
}
