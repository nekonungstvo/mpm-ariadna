...
public class ModelBreasts extends noppes.mpm.client.model.ModelPartInterface
{
  ...
  public ModelBreasts(ModelMPM base)
  {
    ...
    this.breasts = new Model2DRenderer(base, 20.0F, 22.0F, 8, 3, 64.0F, 64.0F);
    ...
    Model2DRenderer bottom = new Model2DRenderer(base, 20.0F, 22.0F, 8, 4, 64.0F, 64.0F);
    ...
    Model2DRenderer right = new Model2DRenderer(base, 20.0F, 22.0F, 3, 2, 64.0F, 64.0F);
    right.setRotationPoint(-3.8F, 5.3F, -3.6F);
    right.setScale(0.12F, 0.14F);
    right.setThickness(1.75F);
    this.breasts3.addChild(right);
    
    Model2DRenderer right2 = new Model2DRenderer(base, 20.0F, 22.0F, 3, 1, 64.0F, 64.0F);
    ...
    Model2DRenderer right3 = new Model2DRenderer(base, 20.0F, 24.0F, 3, 1, 64.0F, 64.0F);
    ...
    Model2DRenderer right4 = new Model2DRenderer(base, 23.0F, 22.0F, 1, 2, 64.0F, 64.0F);
    ...
    Model2DRenderer left = new Model2DRenderer(base, 25.0F, 22.0F, 3, 2, 64.0F, 64.0F);
    left.setRotationPoint(0.8F, 5.3F, -3.6F);
    left.setScale(0.12F, 0.14F);
    left.setThickness(1.75F);
    this.breasts3.addChild(left);
    
    Model2DRenderer left2 = new Model2DRenderer(base, 25.0F, 22.0F, 3, 1, 64.0F, 64.0F);
    ...
    Model2DRenderer left3 = new Model2DRenderer(base, 25.0F, 24.0F, 3, 1, 64.0F, 64.0F);
    ...
    Model2DRenderer left4 = new Model2DRenderer(base, 24.0F, 22.0F, 1, 2, 64.0F, 64.0F);
