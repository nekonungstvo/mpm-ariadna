...
public class ModelCtenoTail extends MCAToMPMModelRenderer {
    ...
    public ModelCtenoTail(ModelMPM base) {
        ...
        segment1.addBox(-2.5F, -1.0F, -3.0F, 5, 4, 4);
        segment1.setInitialRotationPoint(0.0F, 1.0F, -2.0F);
        ...
        segment2.addBox(-4.0F, -3.5F, -7.0F, 8, 7, 7);
        segment2.setInitialRotationPoint(0.0F, 0.5F, -2.0F);
        segment2.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(-0.06104854F, 0.0F, 0.0F, 0.9981348F)).transpose());
        ...
        segment3.addBox(-4.5F, -4.0F, -5.0F, 9, 7, 7);
        segment3.setInitialRotationPoint(0.0F, 1.0F, -6.0F);
        segment3.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(0.40673664F, 0.0F, 0.0F, 0.9135454F)).transpose());
        ...
        thorn24.setInitialRotationPoint(3.5F, -1.0F, -2.5F);
        ...
        segment4.addBox(-4.0F, -3.0F, -5.0F, 8, 7, 7);
        segment4.setInitialRotationPoint(0.0F, 0.0F, -5.0F);
        segment4.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(0.34202012F, 0.0F, 0.0F, 0.9396926F)).transpose());
        ...
        thorn32.setInitialRotationPoint(0.0F, 2.0F, 0.0F);
        ...
        thorn33.setInitialRotationPoint(4.0F, 0.0F, -1.0F);
        ...
        segment5.setInitialRotationPoint(0.0F, 0.0F, -4.0F);
        segment5.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(-0.26723838F, 0.0F, 0.0F, 0.96363044F)).transpose());
        ...
        segment6.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(-0.43837115F, 0.0F, 0.0F, 0.89879405F)).transpose());
        ...
        topBulb.addBox(-1.0F, -1.0F, -2.0F, 2, 2, 3);
        topBulb.setInitialRotationPoint(0.0F, -0.5F, -4.0F);
        topBulb.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(0.0F, 0.0F, 0.0F, 1.0F)).transpose());
